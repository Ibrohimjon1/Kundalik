...
public class Qarzdorlar_izox extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cursor1 = AsosiyOyna.sqLiteHelper.getData("SELECT * FROM QARZDORLAR WHERE Id LIKE '" + id + "'");
        ...
        imageView_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(Qarzdorlar_izox.this);
    ...
    private void showDialogUpdate(final String id, final String tanish_ismi, final String summa, final String sana, final String izox) {
        ...
        final Dialog dialog = new Dialog(Qarzdorlar_izox.this);
...
//        edt_summa.addTextChangedListener(new NumberTextWatcherForThousand(edt_summa, 2, null));
        int width = Qarzdorlar_izox.this.getResources().getDisplayMetrics().widthPixels;
        int height = (int) (Qarzdorlar_izox.this.getResources().getDisplayMetrics().heightPixels);
    ...
    private void showDialogDelete(final int deleting) {
        final AlertDialog.Builder dialogDelete = new AlertDialog.Builder(Qarzdorlar_izox.this);
