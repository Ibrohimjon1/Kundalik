...
public class Chiqim_sana extends AppCompatActivity {
...
//    ArrayList<String> kirim_items = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_kirim_nomi_yoq.setText("Chiqimda hech nima yo'q");
...
//        btn_kirim_add.setVisibility(View.GONE);
        ...
        btn_kirim_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Chiqim_sana.this, Chiqim_Add.class);
                startActivity(intent);
            }
        });

        try {
            int son = getdata("SELECT DISTINCT sana FROM CHIQIM ORDER BY sana_solish DESC");
            if (son == 0) {
                Toast.makeText(getApplicationContext(), "Chiqimda hech nima yo'q!", Toast.LENGTH_SHORT).show();
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//        gridView.setChoiceMode(AbsListView.CHOICE_MODE_MULTIPLE_MODAL);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Chiqim_sana.this, Chiqim_royh_yangi.class);
...
//        });
        ...
        gridView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, final View view, final int position, long id) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(Chiqim_sana.this);
                ...
                dialog.setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        ...
                        if (item == 0) {
                            //Update
                            Toast.makeText(getApplicationContext(), "Bu yerda o'zgartirish mumkin emas!", Toast.LENGTH_SHORT).show();
...
//                            showDialog_Update(Savdo_sana_yangi.this, Integer.parseInt(id), txt_kirim.getText().toString());
    ...
    private void showDialogDelete_for_one(final String sana) {
        AlertDialog.Builder dialogDelete = new AlertDialog.Builder(Chiqim_sana.this);
        ...
        dialogDelete.setPositiveButton("Ha", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                try {
                    AsosiyOyna.sqLiteHelper.insertData_Shot_nomi(sana, "DELETE FROM CHIQIM WHERE sana = ?");
                    Toast.makeText(getApplicationContext(), "Muvaffaqqiyatli o'chirildi!!!", Toast.LENGTH_SHORT).show();
                } catch (Exception error) {
                    error.printStackTrace();
                }
                getdata("SELECT DISTINCT sana FROM CHIQIM ORDER BY sana_solish DESC");
            }
        });
...
//        final AlertDialog.Builder dialogDelete = new AlertDialog.Builder(Chiqim_sana.this);
...
//                        Cursor cursor = AsosiyOyna.sqLiteHelper.getData("SELECT Id FROM CHIQIM WHERE sana LIKE '" + id_shot + "'");
//                        if (cursor.getCount() != -1){
//                            cursor.moveToFirst();
//                            do {
//                                int id = cursor.getInt(0);
//                                AsosiyOyna.sqLiteHelper.deleteData_Shot_nomi(id, "DELETE FROM CHIQIM WHERE Id = ?");
