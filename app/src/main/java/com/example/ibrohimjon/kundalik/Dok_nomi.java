...
public class Dok_nomi extends AppCompatActivity {
...
//    ArrayList<String> kirim_items = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edt_kirim_nomi.setHint("Do'kon nomi");
        txt_kirim_nomi_yoq = (TextView) findViewById(R.id.txt_kirim_nomi_yoq);

        assert txt_kirim_nomi_yoq != null;
        txt_kirim_nomi_yoq.setText("Do'kon nomida hech nima yo'q");

        adapter = new Kirim_nomi_adapter(this, R.layout.kirim_nomi_items, list);
        gridView.setAdapter(adapter);

        try {
            int son = getdata("SELECT * FROM DOKON_NOMI ORDER BY name ASC");
            if (son == 0) {
                Toast.makeText(getApplicationContext(), "Do'kon nomida hech nima yo'q!", Toast.LENGTH_SHORT).show();
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//        gridView.setChoiceMode(AbsListView.CHOICE_MODE_MULTIPLE_MODAL);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, final View view, int position, long id) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(Dok_nomi.this);
                ...
                final int id3 = Integer.parseInt(txt_id.getText().toString().trim());
                ...
                dialog.setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        ...
                        if (item == 0) {
                            //Update
                            showDialog_Update(Dok_nomi.this, id3, txt_chiqim.getText().toString().trim());
...
//                    @Override
//                    public void onClick(DialogInterface dialog, int item) {
//                        TextView txt = (TextView) view.findViewById(R.id.txt_kirim_item_id);
//                        String id = txt.getText().toString();
//                        if (item == 0) {
//                            //Update
//                            TextView txt_kirim = (TextView) view.findViewById(R.id.txt_kirim_name);
//                            showDialog_Update(Dok_nomi.this, Integer.parseInt(id), txt_kirim.getText().toString());
//                        } else {
//                            // delete
//                            showDialogDelete(Integer.parseInt(id));
//                        }
//                    }
//                });
//                dialog.show();
...
//        });
        ...
        btn_kirim_filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (a == 1) {
                    getdata("SELECT * FROM DOKON_NOMI ORDER BY name ASC");
                    btn_kirim_filter.setImageResource(images_btn[1]);
                    a = 2;
                } else if (a == 2) {
                    getdata("SELECT * FROM DOKON_NOMI ORDER BY name DESC");
        ...
        btn_kirim_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!edt_kirim_nomi.getText().toString().equals("")) {
                    ...
                    try {
                        String sql = "INSERT INTO DOKON_NOMI VALUES (NULL, ?)";
                    ...
                    Toast.makeText(getApplicationContext(), "Iltimos Do'kon nomini kiriting!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void showDialogDelete_for_one(final int id) {
        AlertDialog.Builder dialogDelete = new AlertDialog.Builder(Dok_nomi.this);
        ...
        dialogDelete.setPositiveButton("Ha", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                try {
                    AsosiyOyna.sqLiteHelper.deleteData_Shot_nomi(id, "DELETE FROM DOKON_NOMI WHERE Id = ?");
    ...
    private void showDialog_Update(Activity activity, final int id, final String kirim_nomi) {
        ...
        edt_kirim_upd.setHint("Do'kon nomi");
            ...
            public void onClick(View v) {
                try {
                    if (!edt_kirim_upd.getText().toString().equals("")) {
                        AsosiyOyna.sqLiteHelper.updateData_shot_nomi("UPDATE DOKON_NOMI SET name = ? WHERE Id = ?", edt_kirim_upd.getText().toString(), id);
...
//                        AsosiyOyna.sqLiteHelper.deleteData_Shot_nomi(Integer.parseInt(id_shot), "DELETE FROM DOKON_NOMI WHERE Id = ?");
//                    }
//                    for (int i = 0; i < gridView.getCount(); i++) {
//                        gridView.getChildAt(i).setBackgroundColor(Color.TRANSPARENT);
//                    }
