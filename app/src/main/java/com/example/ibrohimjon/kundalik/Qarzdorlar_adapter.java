...
public class Qarzdorlar_adapter extends BaseAdapter {
    private Context context;
    private int layout;
    private ArrayList<Qarzdorlar_list> Qarz_list;

    public Qarzdorlar_adapter(Context context, int layout, ArrayList<Qarzdorlar_list> Qarz_list) {
    ...
    private class ViewHolder {
        TextView txt_summa, txt_tanish, txt_bosh_harf, txt_sana, txt_qarz_id;
    }
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        Qarzdorlar_list qarzdorlar_list= Qarz_list.get(position);
