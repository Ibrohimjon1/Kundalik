...
public class Qarzdorlar_sana_yangi extends AppCompatActivity {
    ...
    public static String qarzdor_ismi = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_kirim_nomi_yoq.setText("Qarzdorlarda hech nima yo'q");
...
//        btn_qarz_add.setVisibility(View.GONE);
        ...
        btn_qarz_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Qarzdorlar_sana_yangi.this, Qarzdorlar_add.class);
                startActivity(intent);
            }
        });

        adapter = new Qarzdorlar_sana_adapter(Qarzdorlar_sana_yangi.this, R.layout.savdo_royhat_items, list);
        listView.setAdapter(adapter);

        String sql = "SELECT DISTINCT tanish_ismi FROM QARZDORLAR ORDER BY tanish_ismi ASC";
        Get_data(sql);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                qarzdor_ismi = data;
                Intent intent = new Intent(Qarzdorlar_sana_yangi.this, Qarzdorlar_royh.class);
//                intent.putExtra("tanish", data);
        ...
        btn_qarz_filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (a == 1) {
                    ...
                    String sql = "SELECT DISTINCT tanish_ismi FROM QARZDORLAR ORDER BY tanish_ismi DESC";
                    Get_data(sql);
        ...
        edt_tanish.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (!edt_tanish.getText().toString().equals("")) {
                    String sql = "SELECT DISTINCT tanish_ismi FROM QARZDORLAR WHERE tanish_ismi LIKE '" + edt_tanish.getText().toString().replace("'", "''") + "%' ORDER BY tanish_ismi ASC";
                    int qaytdi = Get_filter_data(sql);
                    if (qaytdi == 0) {
                        String sql1 = "SELECT DISTINCT tanish_ismi FROM QARZDORLAR WHERE tanish_ismi LIKE '%" + edt_tanish.getText().toString().replace("'", "''") + "%' ORDER BY tanish_ismi ASC";
                        int aa = Get_filter_data(sql1);
                        if (aa == 0) {
                            txt_kirim_nomi_yoq.setText("Qarzdorlarda bunday odam yo'q");
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, final View view, final int position, long id) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(Qarzdorlar_sana_yangi.this);
...
//                            showDialog_Update(Savdo_sana_yangi.this, Integer.parseInt(id), txt_kirim.getText().toString());
    ...
    private void showDialogDelete_for_one(final String tanish_ismi) {
        AlertDialog.Builder dialogDelete = new AlertDialog.Builder(Qarzdorlar_sana_yangi.this);
        ...
        dialogDelete.setPositiveButton("Ha", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                try {
                    AsosiyOyna.sqLiteHelper.insertData_Shot_nomi(tanish_ismi, "DELETE FROM QARZDORLAR WHERE tanish_ismi = ?");
    ...
    public static void Get_data(String sql) {
        ...
        if (cursor.getCount() != 0) {
            ...
            do {
                ...
                String sql1 = "SELECT * FROM QARZDORLAR WHERE tanish_ismi LIKE '" + tanish.replace("'", "''") + "'";
            ...
            txt_kirim_nomi_yoq.setText("Qarzdorlarda hech nima yo'q");
            txt_kirim_nomi_yoq.setVisibility(View.VISIBLE);
//            Toast.makeText(, "Qarzdorlarda hech nima yo'q!", LENGTH_SHORT).show();
        }

    }

    public static int Get_filter_data(String sql) {
