...
public class Qarzdorlar_add extends AppCompatActivity {
...
//        edt_summa.focusedProperty().addListener((arg0, oldValue, newValue) -> {
...
//                Qoshish();
    ...
    private void Yangi_qoshish() {
        View row;
        LayoutInflater inflater = (LayoutInflater) Qarzdorlar_add.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
...
//        //qora chiziq tortish
//        liniya = new ImageView(Qarzdorlar_add.this);
//        liniya.setBackgroundColor(Color.GRAY);
...
//
//        layout_tanish = new LinearLayout(Qarzdorlar_add.this);
...
//        dynamic_txt_tanish = new TextView(Qarzdorlar_add.this);
...
//        dynamic_auto_qarz = new AutoCompleteTextView(Qarzdorlar_add.this);
...
//        dynamic_auto_qarz.setHint("Qarzdor");
...
//
//
//        layout_summa = new LinearLayout(Qarzdorlar_add.this);
...
//
//        //edit_summa yaratish
//        dynamic_edittext = new EditText(Qarzdorlar_add.this);
...
//        grid_layout.addView(layout_summa);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_add) {
            ...
            Intent intent = new Intent(Qarzdorlar_add.this, Qarzdorlar_sana_yangi.class);
    ...
    private void Yangi_saqlash() {
        try {
            ...
            String sql = "INSERT INTO QARZDORLAR (tanish_ismi, summa, sana, haq_summa, sana_solish, izox) VALUES (?, ?, ?, ?, ?, ?)";
            ...
            finish();
            String sql5 = "SELECT DISTINCT tanish_ismi FROM QARZDORLAR ORDER BY tanish_ismi ASC";
            Qarzdorlar_sana_yangi.Get_data(sql5);
