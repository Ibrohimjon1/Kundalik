...
public class Chiqim_nomi extends AppCompatActivity {
...
//    ArrayList<String> kirim_items = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_kirim_nomi_yoq.setText("Chiqim nomida hech nima yo'q!");

        edt_kirim_nomi.setHint("Chiqim nomi");
        adapter = new Kirim_nomi_adapter(this, R.layout.kirim_nomi_items, list);
        gridView.setAdapter(adapter);

        try {
            int son = getdata("SELECT * FROM CHIQIM_NOMI ORDER BY name ASC");
            if (son == 0) {
                Toast.makeText(getApplicationContext(), "Chiqim nomida hech nima yo'q!", Toast.LENGTH_SHORT).show();
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, final View view, int position, long id) {
                ...
                try {
                    ...
                    AlertDialog.Builder dialog = new AlertDialog.Builder(Chiqim_nomi.this);
                    ...
                    dialog.setItems(items, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int item) {
                            ...
                            if (item == 0) {
                                //Update
                                showDialog_Update(Chiqim_nomi.this, id3, txt_chiqim.getText().toString().trim());
...
//        });
        ...
        btn_kirim_filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (a == 1) {
                    getdata("SELECT * FROM CHIQIM_NOMI ORDER BY name ASC");
                    btn_kirim_filter.setImageResource(images_btn[1]);
                    a = 2;
                } else if (a == 2) {
                    getdata("SELECT * FROM CHIQIM_NOMI ORDER BY name DESC");
        ...
        btn_kirim_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!edt_kirim_nomi.getText().toString().equals("")) {
                    ...
                    try {
                        String sql = "INSERT INTO CHIQIM_NOMI VALUES (NULL, ?)";
                    ...
                    Toast.makeText(getApplicationContext(), "Chiqim nomini kiriting!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void showDialog_Update(Activity activity, final int id, final String kirim_nomi) {
        ...
        edt_kirim_upd.setHint("Chiqim nomi");
            ...
            public void onClick(View v) {
                try {
                    if (!edt_kirim_upd.getText().toString().equals("")) {
                        AsosiyOyna.sqLiteHelper.updateData_shot_nomi("UPDATE CHIQIM_NOMI SET name = ? WHERE Id = ?", edt_kirim_upd.getText().toString().trim(), id);
...
//        AlertDialog.Builder dialogDelete = new AlertDialog.Builder(Chiqim_nomi.this);
...
//                        AsosiyOyna.sqLiteHelper.deleteData_Shot_nomi(Integer.parseInt(id_shot), "DELETE FROM CHIQIM_NOMI WHERE Id = ?");
//                    }
//                    for (int i = 0; i < gridView.getCount(); i++) {
//                        gridView.getChildAt(i).setBackgroundColor(Color.TRANSPARENT);
//                    }
    ...
    private void showDialogDelete_for_one(final int id) {
        ...
        dialogDelete.setPositiveButton("Ha", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                try {
                    AsosiyOyna.sqLiteHelper.deleteData_Shot_nomi(id, "DELETE FROM CHIQIM_NOMI WHERE Id = ?");
                    Toast.makeText(getApplicationContext(), "Muvaffaqqiyatli o'chirildi!!!", Toast.LENGTH_SHORT).show();
                } catch (Exception error) {
                    error.printStackTrace();
                }
